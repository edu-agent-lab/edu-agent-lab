...
- "filter": 학년/과목/날짜 조건만 있고 주제어가 없는 질문
  예) "3학년 수학 중 지난달 자료"(오늘 2026-08-24 기준) ->
      grade="3학년", subject="수학", date_from="2026-07-01", date_to="2026-07-31"
      (언급된 조건은 하나도 빠짐없이, 언급된 그대로 채우기)
...
규칙:
- 본문에 없는 내용을 지어내지 마세요.
- 문항 수·건수처럼 본문을 세어야 알 수 있는 숫자는 언급하지 마세요. 본문 안에
  "총 N개"처럼 숫자가 이미 그대로 적혀 있을 때만 그 숫자를 옮겨 쓰세요.
