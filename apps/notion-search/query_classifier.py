...
#
# "수업"은 "과학 수업 자료 찾아줘"처럼 과목명 뒤에 관용적으로 붙는 말이라 실제
# 검색 신호가 아니다. 걷어내지 않으면 subject 필터는 맞는데 keyword="수업"이
# 남아 스코어링에서 컷오프(MIN_KEYWORD_SCORE)를 못 넘겨 결과가 0건이 된다.
_STOPWORDS = [
    "찾아줘", "찾아", "요약해줘", "보여줘", "알려줘", "해줘", "있어", "있나",
    "관련", "페이지", "자료", "교과", "과목", "내용", "정도", "수업",
]
